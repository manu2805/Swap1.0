...
class SwiftPages: UIView, UIScrollViewDelegate {
    ...
    //Item size variables
    private var topBarHeight: CGFloat = 54
    ...
    override func drawRect(rect: CGRect)
    {
        ...
        //Set the top bar
        topBar = UIView(frame: CGRectMake(0, 0, containerView.frame.size.width, topBarHeight + 2))
        ...
        if (!buttonsWithImages) {
            ...
            {
                var barButton: UIButton!
                barButton = UIButton(frame: CGRectMake(buttonsXPosition, 10, containerView.frame.size.width/(CGFloat)(viewControllerIDs.count), topBarHeight))
                barButton.backgroundColor = UIColor.clearColor()
        ...
        animatedBar = UIView(frame: CGRectMake(0, topBarHeight - animatedBarHeight + 4, (containerView.frame.size.width/(CGFloat)(viewControllerIDs.count))*0.8, animatedBarHeight))
